...
export const metadata: Metadata = {
  title: "Loquaci Farms | Fresh Organic Produce by Carson Loquaci",
  description: "Get premium organic vegetables fresh from Carson Loquaci's sustainable farm. Farm-to-table quality delivered to your door.",
  keywords: "organic produce, fresh vegetables, sustainable farming, Carson Loquaci, farm fresh, organic farming",
  metadataBase: new URL("https://loquacifarms.com"),
  alternates: {
    canonical: "https://loquacifarms.com"
  },
  openGraph: {
    title: "Loquaci Farms | Fresh Organic Produce",
    description: "Premium organic vegetables from our sustainable family farm",
    type: "website",
    siteName: "Loquaci Farms",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764883513121-tg41cy3c.jpg",
  ...
  twitter: {
    ...
    title: "Loquaci Farms | Fresh Organic Produce",
    description: "Premium organic vegetables from our sustainable family farm",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764883513121-tg41cy3c.jpg"]
  }
};
